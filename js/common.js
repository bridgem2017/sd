  ...
  document.body.insertAdjacentHTML('beforeend', `<footer class="footer">
    <div class="container footer-grid footer-contact-only">
      ...
      <div>
        <h4>CONTACT</h4>
        <p>상호/대표 : 김운기</p>
        <p>사업자등록번호 : 402-33-94847</p>
        <p>개인정보책임자 : 박성인</p>
        <p>대표전화 : 0507-1330-1177</p>
        <p>팩스번호 : 070-4253-1177</p>
        <p>상담 메일 : sales@box.re.kr</p>
        <p>영업시간 : 평일 09:00 - 18:00</p>
        <p>주소 : 경기도 김포시 통진읍 마송2로104번길 155 가동</p>
        <p class="copyright">Copyrights 2026 SD COMPANY Co.,Ltd. All rights reserved.</p>
      </div>
    </div>
